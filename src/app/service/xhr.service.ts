...
export class XhrService {  
    ...
    public get(url: string, params?: any, options?: any) {
        ...
        if(this.isNative()){
            ...
            return from(this.http.get(url, params, {})).pipe(map(x=>x.data)).pipe(map(x=>JSON.parse(x)));
    ...
    post(url: string, params?: any, options?: any): Observable<any> {
        if(this.isNative()){
            ...
            return from(this.http.post(url, params, {})).pipe(map(x=>x.data)).pipe(map(x=>JSON.parse(x)));
